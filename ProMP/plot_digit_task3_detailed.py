#!/usr/bin/env python3
"""
Plot detailed trajectory for task 3, using the second demo as original.
...
def main():
    parser = argparse.ArgumentParser(description="Plot detailed trajectory for task 3.")
    parser.add_argument(
        "--digit_library",
        type=str,
    ...
    parser.add_argument(
        "--out",
        type=str,
        default="ProMP/vis/digit_task3_detailed.png",
    ...
    ax.set_title(f'Sample Trajectory Comparison: Task 3',
