#!/usr/bin/env python3
"""
Plot detailed trajectory for task 1, using the second demo as original.
...
def main():
    parser = argparse.ArgumentParser(description="Plot detailed trajectory for task 1.")
    parser.add_argument(
        "--digit_library",
        type=str,
    ...
    parser.add_argument(
        "--out",
        type=str,
        default="ProMP/vis/digit_task1_detailed.png",
    ...
    # Resolve paths relative to script's parent directory (project root)
    ...
    ax.set_title(f'Sample Trajectory Comparison: Task 1',
