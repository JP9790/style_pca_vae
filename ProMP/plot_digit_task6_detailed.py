#!/usr/bin/env python3
"""
Plot detailed trajectory for task 6, using the second demo as original.
...
def main():
    parser = argparse.ArgumentParser(description="Plot detailed trajectory for task 6.")
    parser.add_argument(
        "--digit_library",
        type=str,
    ...
    parser.add_argument(
        "--out",
        type=str,
        default="ProMP/vis/digit_task6_detailed.png",
    ...
    parser.add_argument(
        ...
        type=float,
        default=16.0,
        help="Aggressiveness factor for personalization (default: 16.0 for more aggressive).",
    )
    parser.add_argument(
        "--style_cov_scale",
        type=float,
        default=0.7,
        help="Scale factor for style covariance addition (Method 4, default: 0.7 for more aggressive).",
    )
    ...
    ax.set_title(f'Sample Trajectory Comparison: Task 6',
