#!/usr/bin/env python3
"""
Plot detailed trajectory for task 4, using the second demo as original.
...
def main():
    parser = argparse.ArgumentParser(description="Plot detailed trajectory for task 4.")
    parser.add_argument(
        "--digit_library",
        type=str,
    ...
    parser.add_argument(
        "--out",
        type=str,
        default="ProMP/vis/digit_task4_detailed.png",
    ...
    ax.set_title(f'Sample Trajectory Comparison: Task 4',
