#!/usr/bin/env python3
"""
Plot detailed trajectories for User 2 for all digits (0-9).
...
def main():
    parser = argparse.ArgumentParser(description="Plot detailed trajectories for User 2 - all digits.")
    parser.add_argument(
        "--digit_library",
        type=str,
        default="user2_digit_generic_library",
        help="Path to User 2's digit generic library directory.",
    )
    parser.add_argument(
        "--digit_trajectories",
        type=str,
        default="user_2_digit_library_output",
        help="Directory containing User 2's digit trajectory CSVs.",
    )
    parser.add_argument(
        "--pca_results",
        type=str,
    ...
    parser.add_argument(
        "--out_dir",
        type=str,
        default="ProMP/vis/user2_digits",
    ...
    print("="*60)
    print("PLOTTING USER 2 DIGIT TRAJECTORIES")
    print("="*60)
    ...
    # Process each digit task
    output_dir.mkdir(parents=True, exist_ok=True)
    digits = [str(i) for i in range(10)]
    
    for task_id in digits:
        print(f"\nProcessing digit {task_id}...")
        ...
        # Use less aggressive settings for digit 3
        if task_id == '3':
            task_aggressiveness = args.aggressiveness * 0.5  # Half aggressiveness for digit 3
        ...
        ax.set_title(f'Sample Trajectory Comparison: Task {task_id}',
        ...
        plt.tight_layout()
        output_file = output_dir / f"user2_digit_task{task_id}_detailed.png"
