#!/usr/bin/env python3
"""
Plot detailed trajectory for task U (letter U), using the first demo as original.
...
def main():
    parser = argparse.ArgumentParser(description="Plot detailed trajectory for task U.")
    parser.add_argument(
        "--alphabet_library",
        type=str,
    ...
    parser.add_argument(
        "--out",
        type=str,
        default="ProMP/vis/alphabet_taskU_detailed.png",
    ...
    y_rotated = rotate_180(y)
    generic_traj_rotated = rotate_180(generic_traj)
    personalized_traj_rotated = rotate_180(personalized_traj)
    ...
    ax.set_title(f'Sample Trajectory Comparison: Letter u',
