#!/usr/bin/env python3
"""
Plot detailed trajectory for task C (letter C), using the first demo as original.
...
def main():
    parser = argparse.ArgumentParser(description="Plot detailed trajectory for task C.")
    parser.add_argument(
        "--alphabet_library",
        type=str,
    ...
    parser.add_argument(
        "--out",
        type=str,
        default="ProMP/vis/alphabet_taskc_detailed.png",
    ...
    ax.set_title(f'Sample Trajectory Comparison: Letter c',
