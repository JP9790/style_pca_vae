#!/usr/bin/env python3
"""
Plot detailed trajectory for task 9, using the second demo as original.
...
def main():
    parser = argparse.ArgumentParser(description="Plot detailed trajectory for task 9.")
    parser.add_argument(
        "--digit_library",
        type=str,
    ...
    parser.add_argument(
        "--out",
        type=str,
        default="ProMP/vis/digit_task9_detailed.png",
    ...
    parser.add_argument(
        ...
        type=float,
        default=20.0,
        help="Aggressiveness factor for personalization (default: 20.0 for very aggressive).",
    )
    parser.add_argument(
        "--style_cov_scale",
        type=float,
        default=0.9,
        help="Scale factor for style covariance addition (Method 4, default: 0.9 for very aggressive).",
    )
    ...
    ax.set_title(f'Sample Trajectory Comparison: Task 9',
